...
execute as @a[nbt={SelectedItem:{tag:{EntityTag:{tag:[gun]}}}}] run function cultepack:weapons/effect/delay_3explo_2
execute as @a[nbt={SelectedItem:{tag:{EntityTag:{tag:[gun_2]}}}}] run function cultepack:weapons/effect/delay_3explo
