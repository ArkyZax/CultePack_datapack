execute as @s if predicate cultepack:shield_force1 at @s run effect give @s strength 1 0 true
execute as @s if predicate cultepack:shield_jump1 at @s run effect give @s jump_boost 1 0 true
execute as @s if predicate cultepack:shield_speed1 at @s run effect give @s speed 1 0 true
