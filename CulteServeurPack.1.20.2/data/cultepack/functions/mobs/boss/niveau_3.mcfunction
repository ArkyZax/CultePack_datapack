...
summon minecraft:zombie ~ ~20 ~ {CustomName:'[{"text":"ROI ZOMBIE","color":"dark_red","bold":true}]',HandItems:[{id:carved_pumpkin,tag:{CustomModelData:12},Count:1},{id:carved_pumpkin,tag:{CustomModelData:12},Count:1}],ArmorItems:[{},{},{},{id:carved_pumpkin,tag:{CustomModelData:11},Count:1}],HandDropChances:[0f,0f],ArmorDropChances:[0f,0f,0f,0f],active_effects:[{id:"minecraft:slow_falling",duration:30,amplifier:1,showp_articles:1b}],CustomNameVisible:1b,Health:800,Tags:["roi_zombie"],Attributes:[{Name:"generic.attack_damage",Base:20f},{Name:"generic.movement_speed",Base:0.3f},{Name:"generic.max_health",Base:800f}]}
