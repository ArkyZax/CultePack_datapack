...
clear @s minecraft:popped_chorus_fruit{Tags:["pierre_invoc_4"]} 1 



summon minecraft:zombie ~ ~20 ~ {CustomName:'[{"text":"Zombie Mutant","color":"green"}]',DeathLootTable:"cultepack:entities/zombie_mutant",Tags:["zombie_mutant"],CustomNameVisible:1b,Health:1000,Attributes:[{Name:"generic.max_health",Base:1000f},{Name:"generic.armor",Base:10f},{Name:"generic.attack_damage",Base:80f},{Name:"generic.attack_knockback",Base:10f},{Name:"generic.movement_speed",Base:0.4f}],ArmorItems:[{},{},{},{id:carved_pumpkin,tag:{CustomModelData:13},Count:1}],ArmorDropChances:[0f,0f,0f,0f],active_effects:[{id:"minecraft:slow_falling",duration:30,amplifier:1,showp_articles:1b}],HandItems:[{id:carved_pumpkin,tag:{CustomModelData:14},Count:1},{id:carved_pumpkin,tag:{CustomModelData:15},Count:1}],HandDropChances:[0f,0f]}
